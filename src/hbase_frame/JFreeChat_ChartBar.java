...
public class JFreeChat_ChartBar {
	...
	public static JFreeChart createChart(CategoryDataset categoryDataset,String title) {
		JFreeChart jfreechart = ChartFactory.createBarChart(title, // 标题
				...
				"气候值", // valueAxisLabel（value轴，纵轴，Y轴的标签）
	...
	// 创建CategoryDataset对象
	public static CategoryDataset createDataset(double[][] da,String[] ro,String[] co) {
		double[][] data = new double[1][12];
		data=da;
		String[] rowKeys =ro;
		String[] columnKeys=co;
